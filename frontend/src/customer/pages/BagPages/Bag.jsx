...
function Bag() {
  ...
  const { setUserProduct } = useContext(UserContext);
  const handleProduct = async (productId) => {
    try {
      const response = await axios
        .post(process.env.VITE_API_PRODUCTBYID1_API, { productId })
        .then((res) => {
  ...
  const handleUpdateCart = async (e, id) => {
    try {
  ...
  return (
    <div>
      {User ? (
        <div>
          <Navigation />
          <section class=" relative z-10 after:contents-[''] bg-gray-500 after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50">
              ...
              <div class="grid grid-cols-12">
                <div class="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8 lg:py-24 w-full max-xl:max-w-3xl max-xl:mx-auto">
                  <div class="flex items-center justify-between pb-8 border-b border-gray-300">
                    ...
                    <h2 class="font-manrope font-bold text-xl leading-8 text-black">
                      {cart.length} Items
                    </h2>
                  </div>
                    ...
                    <div class="col-span-12 md:col-span-5">
                      <div class="grid grid-cols-5">
                        <div class="col-span-3">
                          <p class="font-normal text-lg leading-8 text-black text-center">
                            Quantity
                          </p>
                        </div>
                    ...
                    <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-gray-200 group">
                      <div class="w-full md:max-w-[126px]">
                        <img
                          ...
                          onClick={() => {
                            handleProduct(item.productId._id);
                          }}
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                        <div class="md:col-span-2">
                          <div class="flex flex-col max-[500px]:items-center gap-3">
                            ...
                            <h6 class="font-normal text-base leading-7 text-black">
                              {item.productId.description}
                            </h6>
                            <h6 class="font-medium text-base leading-7 text-black transition-all duration-300 group-hover:text-indigo-600">
                        ...
                        <div class="flex items-center max-[500px]:justify-center h-full max-md:mt-3">
                          <div class="flex items-center h-full">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                handleUpdateCart(e, item.productId._id);
                              }}
                              // value={}
                            />
                        ...
                        <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                          <p class="font-bold text-lg leading-8 text-black text-center transition-all duration-300 group-hover:text-indigo-600">
                ...
                <div class=" col-span-12 xl:col-span-4 bg-gray-700 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24">
